...
ASSETS_PATH = OUTPUT_PATH / Path(r"/Users/enrico/Programmazione/RSA/Codici in Python/build/assets/frame0")
...
canvas.create_text(
    ...
    40.0,
    anchor="nw",
    text="Programma di Cifratura RSA\n               Versione 01",
    fill="#FBF8F8",
    font=("Inter ExtraBold", 14 * -1)
)
...
# Trasforma un numero intero in una stringa di caratteri ASCII  
...
def criptaTesto():
    ...
    # linee da testare
    #z = z-1
    #entry_1.insert("1.0",DaNumeroAStringa(z))

def decriptaTesto():
    
     # linee da testare 
    #testo = entry_1.get("1.0", "end")
    #b = int(DaStringaANumero(testo))
    #b = b+1
